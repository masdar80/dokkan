    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Text(
            'الفترة من: ${DateFormat('yyyy-MM-dd').format(from)} إلى: ${DateFormat('yyyy-MM-dd').format(to)}',
          ),
                ...
                .map(
                  (item) => [
                    ...
                    DateFormat('yyyy-MM-dd').format(
                      DateTime.parse(
                        item[isSales ? 'sale_date' : 'purchase_date'],
                      ),
                    ),
                    item[isSales ? 'sell_price_syp' : 'purchase_price_syp']
                        .toString(),
                    isSales
                        ? item['profit_usd'].toString()
